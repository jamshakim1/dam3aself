    ...
    try:
        ...
        if op.type == 5:
            ...
            if settings["autoAdd"] == True:
                cl.sendMessage(op.param1, "Hello {} thank you for adding me as a friend :D".format(str(cl.getContact(op.param1).displayName)))
        if op.type == 13:
        ...
        if op.type == 25:
            ...
            if msg.contentType == 0:
                ...
                if text.lower() == 'help':
                    ...
                    cl.sendContact(to, "u92da257539ee230b60c1d460bab85015")
                elif text.lower() == 'dell':
                    cl.removeAllMessages(op.param2)
                    cl.sendMessage(to, "Remove Chat")
                    ...
                    cl.sendMessage(to, "bot is restart...")
                    restartBot()
                elif text.lower() == 'runtime':
                    timeNow = time.time()
                    runtime = timeNow - botStart
                    runtime = format_timespan(runtime)
                    cl.sendMessage(to, "Active Bot for {}".format(str(runtime)))
                    ...
                    cl.sendMessage(to, "activate Auto Add")
                elif text.lower() == 'autoadd off':
                    settings["autoAdd"] = False
                    cl.sendMessage(to, "disable Auto Add")
                elif text.lower() == 'autojoin on':
                    settings["autoJoin"] = True
                    cl.sendMessage(to, "activate Auto Join")
                elif text.lower() == 'autojoin off':
                    settings["autoJoin"] = False
                    cl.sendMessage(to, "disable Auto Join")
                elif text.lower() == 'autoleave on':
                    settings["autoLeave"] = True
                    cl.sendMessage(to, "activate Auto Leave")
                elif text.lower() == 'autojoin off':
                    settings["autoLeave"] = False
                    cl.sendMessage(to, "disable Auto Leave")
                elif text.lower() == 'autoread on':
                    settings["autoRead"] = True
                    cl.sendMessage(to, "activate Auto Read")
                elif text.lower() == 'autoread off':
                    settings["autoRead"] = False
                    cl.sendMessage(to, "disable Auto Read")
                elif text.lower() == 'checksticker on':
                    settings["checkSticker"] = True
                    cl.sendMessage(to, "activate Check Details Sticker")
                elif text.lower() == 'checksticker off':
                    settings["checkSticker"] = False
                    cl.sendMessage(to, "disable Check Details Sticker")
                elif text.lower() == 'detectmention on':
                    settings["datectMention"] = True
                    cl.sendMessage(to, "activate Detect Mention")
                elif text.lower() == 'detectmention off':
                    settings["datectMention"] = False
                    cl.sendMessage(to, "disable Detect Mention")
                    ...
                    if 'MENTION' in msg.contentMetadata.keys()!= None:
                        ...
                        try:
                            ...
                            cl.sendMessage(msg.to, "Clone member failed")
                    ...
                    for target in targets:
                        try:
                            ...
                            cl.sendMessage(msg.to,"Target added!")
                            break
                        except:
                    ...
                    for target in targets:
                        try:
                            ...
                            cl.sendMessage(msg.to,"The target is abolished!")
                            break
                        except:
                    ...
                    if settings["mimic"]["target"] == {}:
                        cl.sendMessage(msg.to,"There is no target")
                    else:
                        mc = "╔══[ Mimic List ]"
                    ...
                    if msg.toType == 2:
                        group = cl.getGroup(to)
                        if group.preventedJoinByTicket == False:
                            cl.sendMessage(to, "The QR group is open")
                        else:
                            group.preventedJoinByTicket = False
                            cl.updateGroup(group)
                            cl.sendMessage(to, "open qr group")
                   ...
                   if settings["notifikasi"] == False:
                       ...
                       if settings["lang"] == "JP":
                           cl.sendMessage(msg.to,"notif mode off")
                            ...
                            cl.sendMessage(to, "Please send the picture")
                    ...
                    if msg.to in read["readPoint"]:
                        ...
                        cl.sendMessage(msg.to, "Lurking has not been activated why is it reset?")
                    ...
                    settings["Sider"] = True
                    cl.sendMessage(msg.to,"SIDER IS ON")
                ...
                if settings["checkSticker"] == True:
                    ...
                    if settings["changePicture"] == True:
                        ...
                        cl.sendMessage(to, "change profile photo")
                    if msg.toType == 2:
                        ...
                        for mention in mentionees:
                            if clMID in mention["M"]:
                              if settings["detectMention"] == True:
                                 sendMention(receiver, sender, "", " \nهلا وغلا وكرتونين حلا لبيه ياقلبي😍 ")
        ...
        if op.type == 15:
           ...
           if settings["notifikasi"] == True:
             ...
             image = "http://dl.profile.line.naver.jp/" + contact.pictureStatus
             cl.sendImageWithURL(op.param1,image)
             cl.sendMessage(op.param1,"Oh yeah.... " + cl.getContact(op.param2).displayName + "\nفديته المغادر😂")
